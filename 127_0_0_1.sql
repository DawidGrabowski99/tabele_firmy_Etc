...
--
-- Host: 127.0.0.1
-- Czas generowania: 30 Cze 2021, 00:58
...
('root', '[{\"db\":\"zadanie_emsi\",\"table\":\"tabela pracownicy\"},{\"db\":\"zadanie_emsi\",\"table\":\"dane kontrahent\\u00f3w\"},{\"db\":\"zadanie_emsi\",\"table\":\"delegacje db\"},{\"db\":\"zadanie_emsi\",\"table\":\"faktura vat\"}]');
...
('root', '2021-06-29 22:58:23', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"pl\"}');
...
USE `test`;
--
-- Baza danych: `zadanie_emsi`
--
CREATE DATABASE IF NOT EXISTS `zadanie_emsi` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_polish_ci;
USE `zadanie_emsi`;

-- --------------------------------------------------------

--
-- Struktura tabeli dla tabeli `dane kontrahentów`
--

CREATE TABLE `dane kontrahentów` (
  `Lp.` int(11) NOT NULL,
  `NIP` text COLLATE utf8mb4_polish_ci NOT NULL,
  `REGON` text COLLATE utf8mb4_polish_ci NOT NULL,
  `NAZWA` text COLLATE utf8mb4_polish_ci NOT NULL,
  `Czy płatnik Vat?` text COLLATE utf8mb4_polish_ci NOT NULL,
  `ULICA` text COLLATE utf8mb4_polish_ci NOT NULL,
  `NUMER DOMU` text COLLATE utf8mb4_polish_ci NOT NULL,
  `NUMER MIESZKANIA` text COLLATE utf8mb4_polish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_polish_ci;

-- --------------------------------------------------------

--
-- Struktura tabeli dla tabeli `delegacje db`
--

CREATE TABLE `delegacje db` (
  `Lp.` int(11) NOT NULL,
  `Imię i Nazwisko` text COLLATE utf8mb4_polish_ci NOT NULL,
  `Data od` date NOT NULL,
  `Data do` date NOT NULL,
  `Miejsce wyjazdu` text COLLATE utf8mb4_polish_ci NOT NULL,
  `Miejsce przyjazdu` text COLLATE utf8mb4_polish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_polish_ci;

-- --------------------------------------------------------

--
-- Struktura tabeli dla tabeli `faktura vat`
--

CREATE TABLE `faktura vat` (
  `Lp.` int(11) NOT NULL,
  `Opis` text COLLATE utf8mb4_polish_ci NOT NULL,
  `MPK` text COLLATE utf8mb4_polish_ci NOT NULL,
  `Kwota Netto` mediumtext COLLATE utf8mb4_polish_ci NOT NULL,
  `Ilość` varchar(999) COLLATE utf8mb4_polish_ci NOT NULL,
  `VAT` varchar(999) COLLATE utf8mb4_polish_ci NOT NULL,
  `Kwota Brutto` mediumtext COLLATE utf8mb4_polish_ci NOT NULL,
  `Wartość Netto` mediumtext COLLATE utf8mb4_polish_ci NOT NULL,
  `Wartość Brutto` mediumtext COLLATE utf8mb4_polish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_polish_ci;

-- --------------------------------------------------------

--
-- Struktura tabeli dla tabeli `tabela pracownicy`
--

CREATE TABLE `tabela pracownicy` (
  `Lp.` int(11) NOT NULL,
  ...
  `Ilość Dni  Urlopowych` varchar(100) COLLATE utf8mb4_polish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_polish_ci;

--
-- Zrzut danych tabeli `tabela pracownicy`
--

INSERT INTO `tabela pracownicy` (`Lp.`, `Imię`, `Nazwisko`, `Stanowisko`, `Data Zatrudnienia`, `Ilość Dni  Urlopowych`) VALUES
(1, 'Kasia', 'Nowak', 'Młodszy Analityk', '2019-06-01', '15'),
(2, 'Basia', 'Kowalska', 'Księgowa', '2015-06-23', '26'),
(3, 'Ryszard', 'Steć', 'Prezes', '2015-06-01', '24'),
(4, 'Zenon', 'Wielki', 'Analityk', '2018-09-15', '5'),
(5, 'Kamil', 'Mucha', 'Konserwator', '2015-06-12', '12');
...
--
-- Indeksy dla tabeli `dane kontrahentów`
--
ALTER TABLE `dane kontrahentów`
  ADD PRIMARY KEY (`Lp.`);

--
-- Indeksy dla tabeli `delegacje db`
--
ALTER TABLE `delegacje db`
  ADD PRIMARY KEY (`Lp.`);

--
-- Indeksy dla tabeli `faktura vat`
--
ALTER TABLE `faktura vat`
  ADD PRIMARY KEY (`Lp.`);

--
-- Indeksy dla tabeli `tabela pracownicy`
--
ALTER TABLE `tabela pracownicy`
  ADD PRIMARY KEY (`Lp.`);
...
--
-- AUTO_INCREMENT dla tabeli `delegacje db`
--
ALTER TABLE `delegacje db`
  MODIFY `Lp.` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT dla tabeli `faktura vat`
--
ALTER TABLE `faktura vat`
  MODIFY `Lp.` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT dla tabeli `tabela pracownicy`
--
ALTER TABLE `tabela pracownicy`
